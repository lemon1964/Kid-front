...
class AudioService {
  ...
  constructor() {
    ...
    this.sounds = {
      correct: new Howl({ src: [`${BASE_URL}${prod}/media/sounds/correct.wav`], volume: this.soundEffectsVolume }),
      incorrect: new Howl({ src: [`${BASE_URL}${prod}/media/sounds/incorrect.mp3`], volume: this.soundEffectsVolume }),
      taskCompleted: new Howl({
        src: [`${BASE_URL}${prod}/media/sounds/task_completed.wav`],
